...
The Terms of Reference can be found on the [About](https://github.com/canada-ca/OS-Advisory_Conseil-SO/blob/master/1_About.md) page. If there is an issue with them, please let us know. If not we will confirm these Terms of Reference at the next meeting. 
...
Please go to our [Business Case](2_Business_Case.md) page for further details.

## 5. Open Source Inventory 
* Build a community of practice with the Government of Canada. 
* Ashley is creating an inventoryof what projects people are working on. 
